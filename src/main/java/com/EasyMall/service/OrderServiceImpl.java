...
public class OrderServiceImpl implements OrderService {
    ...
    public boolean delOrder(String oid){return order_dao.deleteOrderByOid(oid);}
    public List<SaleInfo> findSaleInfos(){return order_dao.findSaleInfos();}
    public boolean updateRIOrder(String info,int oid){return order_dao.updateRIOrder(info,oid);}
}
